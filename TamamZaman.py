...
def alan_dolu(alt1, alt2):
    a1 = LocationGlobalRelative(41.0005797, 28.9512378, alt1)  # Tam dolu alanı
...
def alan_yarim(alt1, alt2):
    a1 = LocationGlobalRelative(41.0004422, 28.9512951, alt1)  # Yarı dolu alanı
    vehicle.simple_goto(a1, groundspeed=10)  # 39.8723430, 32.7323806
    time.sleep(20)
...
while True:
    ...
    ###########ikinci sise########################################
locsise = LocationGlobalRelative(41.0003170, 28.95044336, 5)
