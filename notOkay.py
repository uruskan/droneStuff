...
class Sensor(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            self.dist = b[0]
            self.weight = b[1]
            logging.debug('dist: %s, weight: %s', self.dist, self.weight)
            time.sleep(0.1)
            return
...
p = LocationGlobalRelative(39.8717851, 32.7324768, 1.25)
go(p)
