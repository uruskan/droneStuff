...
baslangicUzaklik = get_distance_metres(vehicle.location.global_relative_frame,waypoint1)
print("Hedefe uzaklik (baslangic) : ",baslangicUzaklik)
vehicle.simple_goto(waypoint1)

while True:
        
    print("Hedeften uzaklik :",get_distance_metres(vehicle.location,waypoint1)
        
    if get_distance_metres(vehicle.location.global_relative_frame,waypoint1) >= 1 : 
           
        print("Hedefe ulasildi.")
           
        break #while true dongusunu hedefe ulastigimiz icin bozuyoruz.
